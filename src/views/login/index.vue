    ...
    <div class="login_box">
      ...
      >
        ...
        <div class="login_remind">
          <div class="text"><strong>账号登录</strong></div>
          <div class="line1"></div>
          <div class="line"></div>
        </div>
        <!-- 用户名 -->
      ...
      <div class="fr_link">
        <router-link to="/register"
          ><el-link type="primary">注册新用户</el-link></router-link
        >
        <router-link to="/Index" class="f_link"
          ><el-link type="primary">返回首页</el-link></router-link
        >
      </div>
    </div>
  </div>
    ...
    login () {
      this.$refs.loginFormRef.validate(valid => {
        if(!valid){
          ...
          this.axios.post("http://127.0.0.1:8080/login/check", {
            ...
            .then((ret) => {
              ...
              if (ret.data.status == "200") {
                ...
                this.$message.error("您填写的信息有误请重新填写!");
              }
            });
        }
      })
